# PayEx Payment Provider [![Build status](https://ci.appveyor.com/api/projects/status/sisc29w1o38ifjct?svg=true)](https://ci.appveyor.com/project/PayEx/payex-epi-commerce-payment)

...
namespace PayEx.EPi.Commerce.Payment.PxOrder {
    ...
    public interface PxOrderSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesResponse AddMultipleOrderLines(PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://external.payex.com/PxOrder/AddMultipleOrderLines", ReplyAction="*")]
        System.Threading.Tasks.Task<PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesResponse> AddMultipleOrderLinesAsync(PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface PxOrderSoapChannel : PayEx.EPi.Commerce.Payment.PxOrder.PxOrderSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PxOrderSoapClient : System.ServiceModel.ClientBase<PayEx.EPi.Commerce.Payment.PxOrder.PxOrderSoap>, PayEx.EPi.Commerce.Payment.PxOrder.PxOrderSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesResponse PayEx.EPi.Commerce.Payment.PxOrder.PxOrderSoap.AddMultipleOrderLines(PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesRequest request) {
        ...
        public string AddMultipleOrderLines(long accountNumber, string orderRef, int numberOfItems, string[][] orderDetails, string hash) {
            PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesRequest inValue = new PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesRequest();
            ...
            inValue.hash = hash;
            PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesResponse retVal = ((PayEx.EPi.Commerce.Payment.PxOrder.PxOrderSoap)(this)).AddMultipleOrderLines(inValue);
            return retVal.AddMultipleOrderLinesResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesResponse> PayEx.EPi.Commerce.Payment.PxOrder.PxOrderSoap.AddMultipleOrderLinesAsync(PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesRequest request) {
            return base.Channel.AddMultipleOrderLinesAsync(request);
        }
        
        public System.Threading.Tasks.Task<PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesResponse> AddMultipleOrderLinesAsync(long accountNumber, string orderRef, int numberOfItems, string[][] orderDetails, string hash) {
            PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesRequest inValue = new PayEx.EPi.Commerce.Payment.PxOrder.AddMultipleOrderLinesRequest();
            inValue.accountNumber = accountNumber;
            inValue.orderRef = orderRef;
            inValue.numberOfItems = numberOfItems;
            inValue.orderDetails = orderDetails;
            inValue.hash = hash;
            return ((PayEx.EPi.Commerce.Payment.PxOrder.PxOrderSoap)(this)).AddMultipleOrderLinesAsync(inValue);
        }

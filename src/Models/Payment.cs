...
namespace Epinova.PayExProvider.Models
{
    public class Payment
    {
        ...
        public Payment(long price, string priceArgList, string currency, int vat, string orderId, string productNumber, string description, string clientIpAddress, string clientIdentifier,
